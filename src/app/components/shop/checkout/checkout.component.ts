...
@Component({
    ...
    imports: [CommonModule, TranslateModule, ReactiveFormsModule,
        Select2Module, CurrencySymbolPipe, BreadcrumbComponent,
        ButtonComponent, DeliveryBlockComponent, PaymentBlockComponent,
        AddressBlockComponent, NoDataComponent, LoaderComponent,
