...
@Component({
    selector: 'app-madrid',
    imports: [HomeBannerComponent, BannerComponent, TitleComponent,
        ThemeCategoriesComponent, ProductComponent, WalletOfferComponent,
        DealComponent, TopSellerComponent, ImageLinkComponent,
        BlogComponent, BrandComponent
    ],
