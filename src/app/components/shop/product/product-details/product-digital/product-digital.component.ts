...
import { ProductWholesaleComponent } from '../widgets/product-wholesale/product-wholesale.component';
import { VendorContainComponent } from '../widgets/vendor-contain/vendor-contain.component';
import { VideoPlayModalComponent } from '../widgets/video-play-modal/video-play-modal.component';

@Component({
    selector: 'app-product-digital',
    imports: [TranslateModule, CommonModule, ProductDetailsTabsComponent, VendorContainComponent,
        ProductContainComponent, ProductWholesaleComponent, VideoPlayModalComponent
    ],
