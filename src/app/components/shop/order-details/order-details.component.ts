...
export class OrderDetailsComponent {
  ...
  country$: Observable<{ data: Country[] }> = inject(Store).select(
    CountryState.country
  );
  state$: Observable<{ data: States[] }> = inject(Store).select(
    StateState.state
  );
  ...
  public breadcrumb: Breadcrumb = {
    title: this.translate.instant("order_details"),
    items: [{ label: this.translate.instant("order_details"), active: false }],
  };
